angular
  ...
  .service('dataService', function () {
    ...
    //creates a private variable to do it separately.
    var teamAvengers = [
      {
          "id": 1009368,
          "name": "Iron Man",
  ...
  this.getAvengers = function () {
    ...
    this.avengers = teamAvengers;
    var ans = [];
    for (var hero in teamAvengers) {
      ans.push({
        name: teamAvengers[hero].name,
        description: teamAvengers[hero].description,
        thumbnail: {
          path: teamAvengers[hero].thumbnail.path,
          extension: teamAvengers[hero].thumbnail.extension
        }
      });
    }
    return ans;
